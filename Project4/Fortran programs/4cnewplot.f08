...
PROGRAM ising2dim
  ...
  !This program is run for many MC cycles and calculates the fraction
  !of accepted configurations as a function of temperature
  ...
  DO t = 1, tstep
       ...
       CALL Metropolis(mcs, n_spins, my_rank, w, local_average, spin_matrix,count)
       ! collect all results
       ...
       IF (my_rank == 0) THEN
         ...
         WRITE(8,*) mcs*(n_spins**2)*numprocs, total_count
       ENDIF
     ! update temp
