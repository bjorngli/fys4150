...
PROGRAM ising2dim
  ...
  USE mpi_constants
  USE f90lib
  INTEGER :: n_spins, de, t, tstep, i, cycles, idum
  ...
  !This program calculates the expectation values for energy, magnetization,
  !mean magnetization (abs), heat capacity and susceptibility for lattices of
  !different sizes (decided in input.dat) for temperatures ranging from 2.0 to 2.4
  ...
  IF ( my_rank == 0 ) THEN
     OPEN(UNIT=7,FILE='mc_calc100.dat') !name of this is changed as n_spins is changed
